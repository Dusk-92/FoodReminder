...
------------------------------------------------------------------------------------------
    ...
    -- v1.16 fix: older saves may store isLocked as a table.
    -- The addon logic expects a plain boolean; preserve the saved state.
    if type(settings.isLocked) == "table" then
        if settings.isLocked.value == false then
            settings.isLocked = false;
        else
            settings.isLocked = true;
        end
    elseif type(settings.isLocked) ~= "boolean" then
        settings.isLocked = true;
    end
end
------------------------------------------------------------------------------------------
